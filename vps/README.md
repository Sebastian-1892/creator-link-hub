...
| **Postfix** (`sendmail`) | Bereitstellung von **`/usr/sbin/sendmail`** für Tenant-Laravel (**`MAIL_MAILER=sendmail`**), damit z. B. Passwort-Reset ohne vorab konfiguriertes SMTP funktioniert — siehe Cloud-Doku. |
