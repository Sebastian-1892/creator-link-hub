...
@section('content')
    <div class="max-w-md mx-auto px-4 py-12 pb-28 text-center">
        ...
        <h1 class="text-3xl font-bold tracking-tight">Seite nicht veröffentlicht</h1>
        <p class="mt-4 text-base leading-relaxed text-gray-600">
            Diese Seite ist noch nicht öffentlich freigegeben. Bitte später erneut versuchen.
        </p>
    </div>
@endsection
