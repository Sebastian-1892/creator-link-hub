                ...
                @if (is_array($preset))
                    ...
                    <form wire:submit="addPresetLink" class="mt-5 space-y-4">
                        ...
                        @elseif ($presetType === 'spotify')
                            ...
                            @if ($spotifyPreview)
                                <div>
                                    <p class="mb-2 text-xs font-medium text-gray-500">{{ __('Vorschau') }}</p>
                                    <x-spotify-embed
                                        :embed-url="$spotifyPreview['embed_url']"
                                        :resource-type="$spotifyPreview['resource_type']"
                                        :title="__('Spotify-Vorschau')"
                                    />
                                </div>
